      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-slate-400 font-bold text-[10px] uppercase tracking-[0.2em] mt-3 flex items-center gap-2">
            ...
            Clinical Records & Medical Timeline
          </p>
        </div>
      ...
      <Card className="border-none shadow-2xl rounded-[2.5rem] overflow-hidden bg-white">
        <CardHeader className="bg-slate-50/50 border-b border-slate-100 p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <CardTitle className="text-lg font-black text-slate-900">Patient Consultation Logs</CardTitle>
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="py-32 text-center">
              ...
              <p className="text-slate-400 font-black text-sm uppercase tracking-widest">No consultations recorded yet</p>
            </div>
          ) : (
              ...
              <Table>
                <TableHeader className="bg-slate-50/30">
                  <TableRow className="hover:bg-transparent border-slate-100">
                    <TableHead className="w-[180px] h-14 px-8 text-[10px] font-black uppercase text-slate-400 tracking-widest">Date & Patient</TableHead>
                    <TableHead className="h-14 px-8 text-[10px] font-black uppercase text-slate-400 tracking-widest">Diagnosis & Notes</TableHead>
                    <TableHead className="h-14 px-8 text-[10px] font-black uppercase text-slate-400 tracking-widest">Prescriptions</TableHead>
                    ...
                    <TableRow key={row.id} className="group hover:bg-slate-50/50 transition-all border-slate-100">
                      <TableCell className="px-8 py-6">
                        <div className="flex flex-col gap-1.5">
                          <p className="text-sm font-black text-slate-900">{row.patientName}</p>
                      ...
                      <TableCell className="px-8 py-6">
                        <div className="flex flex-wrap gap-2">
                          {row.prescriptions?.length > 0 ? (
                            ...
                            <span className="text-[10px] text-slate-300 italic">No meds prescribed</span>
                          )}
                        </div>
                      </TableCell>
